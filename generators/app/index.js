...
const baseRootPath = path.dirname(require.resolve('appfolio-js-template'));

/**
 * Base generator. Will copy all required files from appfolio-js-template
 */
...
\`88888P8 88Y888P' 88Y888P' dP   \`88888P' dP dP \`88888P' 
  ...
  configuring() {
    ...
    let packageSettings = _.extend(defaultSettings, {
      ...
      private: true,
      version: '0.0.0',
      description: `${this.appName} - Generated by generator-appfolio-js`,
      main: 'src/index.js',
      // repository: '', // TODO?
      author: this.author
    });
